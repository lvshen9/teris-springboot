...
import com.lvshen.teris.config.LayConfig;
import com.lvshen.teris.control.GameControl;
import com.lvshen.teris.control.PlayerControl;
import com.lvshen.teris.dto.GameDto;
import com.lvshen.teris.ui.Img;
import com.lvshen.teris.ui.Lay;
...
public class JPanelGame extends JPanel {
    ...
    private void initComponent() {
        ...
        //给开始按钮增加事件监听
        this.btnStart.addActionListener(e -> gameControl.start());
        //添加按钮到面板
        this.add(btnStart);
        //初始化设置按钮
