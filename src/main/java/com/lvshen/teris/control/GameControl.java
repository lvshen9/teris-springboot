...
import com.lvshen.teris.config.DataInterfaceConfig;
import com.lvshen.teris.config.GameConfig;
import com.lvshen.teris.dao.Data;
import com.lvshen.teris.dto.GameDto;
import com.lvshen.teris.dto.Player;
import com.lvshen.teris.service.GameService;
import com.lvshen.teris.service.GameTetris;
import com.lvshen.teris.ui.window.JFrameConfig;
import com.lvshen.teris.ui.window.JFrameGame;
import com.lvshen.teris.ui.window.JFrameSavePoint;
import com.lvshen.teris.ui.window.JPanelGame;
...
public class GameControl {
    ...
    private void setControlConfig() {
        //创建键盘码与方法名的映射数组
        this.actionList = Maps.newHashMap();
        try {
            ObjectInputStream ois = new ObjectInputStream(new FileInputStream(CommonUtils.getFullPath("data/control.dat")));
